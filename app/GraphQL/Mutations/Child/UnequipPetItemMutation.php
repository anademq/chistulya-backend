...
class UnequipPetItemMutation extends ChildAuthedMutation
{
    protected $attributes = [
        'name' => 'unequipPetItem',
        'description' => 'Unequip a currently equipped pet item.',
    ];
    ...
    public function args(): array
    {
        return [
            'pet_item_id' => [
                ...
                'description' => 'UUID of the pet item to unequip.',
            ],
        ];
    }
    ...
    public function resolve($root, array $args): array
    {
        ...
        return $this->wrapPayload(function () use ($user, $args): array {
            return ['child_pet_item' => app(PetShopService::class)->unequip($user, $args['pet_item_id'])];
        });
    }
}
